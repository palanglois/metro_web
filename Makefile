...
EMCC_FLAGS = -s NO_EXIT_RUNTIME=1 -s EXTRA_EXPORTED_RUNTIME_METHODS='["ccall", "stringToUTF8"]' -s EXPORTED_FUNCTIONS="['_free', '_malloc']" -s ASSERTIONS=1 -s DISABLE_EXCEPTION_CATCHING=0 -DEMCC=1 -s TOTAL_MEMORY=167772160
